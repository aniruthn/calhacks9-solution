  ...
  useEffect(() => {
    ...
    return onSnapshot(
      ...
      (querySnapshot) => {
        ...
        querySnapshot.forEach((vote: any) => {
          const voteData = vote.data() as RestaurantModel;
        ...
        newVotes.forEach((vote) => {
          ...
          newVotesByRestaurant[vote.restaurantName] =
            newVotesByRestaurant[vote.restaurantName] + 1;
        });
