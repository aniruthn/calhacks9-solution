...
const VotingScreen = () => {
  ...
  const VotingPanel = () => {
    ...
    return (
      <>
        <Text style={styles.restaurantChosen}>Choice: {chosenRestaurant}</Text>
        <Button
          title="Clear Choice"
          onPress={() => setChosenRestaurant("")}
  ...
  const renderRestaurant = ({ item }: { item: RestaurantOption }) => {
    ...
    return (
      <TouchableOpacity onPress={() => setChosenRestaurant(name)}>
        <View style={styles.restaurantContainer}>
          <Text style={styles.restaurantName}>{name}</Text>
          <Text style={styles.restaurantFoods}>{foods}</Text>
        </View>
      </TouchableOpacity>
    );
  };
  ...
  return (
    <SafeAreaView>
      ...
      <FlatList
        ...
        ListHeaderComponent={
          chosenRestaurant ? <VotingPanel /> : <NoRestaurantChosen />
        }
